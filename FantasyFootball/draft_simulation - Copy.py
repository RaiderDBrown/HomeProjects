...
class DraftStrategyManager:
    ...
    def __init__(self, rules_branch, num_rounds):
        """
        Parameters:
    ...
    def generate_branches(self, rules_branch, num_rounds):
        ...
        allfrqs = itertools.product(draft_rounds, repeat=len(rules_branch))
        ...
        freqs = (perm for perm in allfrqs if is_valid(perm, mins, num_rounds))
...
if __name__ == "__main__":
    ...
    while dstats.best < 0.99 and tracker.iteration < 2:
        ...
        time_to_rpt = tracker.iteration - tracker.last_print >= 10
